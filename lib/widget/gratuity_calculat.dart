...
class GratuityCalculateWidget extends StatefulWidget {
  ...
  GratuityCalculateWidget(this.empDetails,this.gratuityType,this.closeDialog, {Key? key}) : super(key: key);
                      ...
                      SizedBox(
                        ...
                        ElevatedButton(
                          onPressed: () async {
                            ...
                            var typeData = widget.gratuityType.firstWhere((e) => e['description']== typCtrl.text);
                            var status = await saveGratuity(data.empCode.toString(),typeData['id'].toString(),'1');
                            if (status){
